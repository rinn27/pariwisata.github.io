        ...
        <div class="col-md-6">
            ...
            <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" class="form-control form" value="" placeholder="Masukan Password Baru">
                </div>
                <div class="form-group">
                    <label for="cpassword" class="control-label">Current Password</label>
                    <input type="password" name="cpassword" class="form-control form" value="" placeholder="Masukan Password Saat Ini">
                </div>
