...
<header class="masthead">
	<div class="container">
		...
		<div class="masthead-heading text-uppercase">Welcome To Sulawesi Utara</div>
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">More Info</a>
	</div>
</header>
<section class="page-section bg-dark" id="home">
			...
			<div class="col-md-4 p-4 ">
				<div class="card w-100 rounded-0">
					...
					<div class="w-100 d-flex justify-content-end">
						<a href="./?page=view_package&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning">Lihat Paket <i class="fa fa-arrow-right"></i></a>
					</div>
					</div>
				</div>
			</div>
	...
	<div class="d-flex w-100 justify-content-end">
		<a href="./?page=packages" class="btn btn-flat btn-warning mr-4">Lihat Semua Paket <i class="fa fa-arrow-right"></i></a>
	</div>
	</div>
</section>
...
<section class="page-section" id="contact">
	<div class="container">
		<div class="text-center">
			...
			<h3 class="section-subheading text-muted">Silahkan Kirim Pertanyaan</h3>
		</div>
		<form id="contactForm" >
			<div class="row align-items-stretch mb-5">
				...
				<div class="col-md-6">
					<div class="form-group form-group-textarea mb-md-0">
						<textarea class="form-control" id="message" name="message" placeholder="Pertanyaan" required></textarea>
					</div>
				</div>
			</div>
